...
var arguments = "x5, dixy, rusneft, phosagro, komtech, ocontract, cpc, novatek, azot, uva, salym, monetka, dtek, mmk, letoile, sistema, metafrax, ies, uralchem, gosby, apk, aztpa, rosatom, tpsre, tektkp, tekgaz, tekmarket, tekrao, tekmos, tekrn, tekkom, tekrusgazbur, tekrosimport, tektyumen, teksil, tekrzd, teksibur, tekppk, tekspec, grls"
var prefix string
var dbName string
var userDb string
var passDb string
...
var tempTekPpk string
var logTekPpk string
var tempTekSpec string
var logTekSpec string
var tempGrls string
var logGrls string
var argS string
var a arg
...
type settings struct {
	...
	TempTekppk       string `xml:"tempdir_tekppk"`
	LogTekppk        string `xml:"logdir_tekppk"`
	TempTekspec      string `xml:"tempdir_tekspec"`
	LogTekspec       string `xml:"logdir_tekspec"`
	TempGrls         string `xml:"tempdir_grls"`
	LogGrls          string `xml:"logdir_grls"`
}
...
func getSetting() {
	...
	logTekPpk = settings.LogTekppk
	tempTekPpk = settings.TempTekppk
	logTekSpec = settings.LogTekspec
	tempTekSpec = settings.TempTekspec
	logGrls = settings.LogGrls
	tempGrls = settings.TempGrls
